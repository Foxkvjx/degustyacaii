...
export default function Dashboard() {
  ...
  const metrics: Metric[] = [
    ...
    { label: "Açaí", value: acai ? `${Number(acai.qtd)} ${acai.unidade === "litros" ? "L" : acai.unidade}` : "0 L", note: "Estoque", Icon: Package },
    { label: "Estoque", value: loading ? "..." : money(stockValue), note: "Valor", Icon: Target },
  ];
