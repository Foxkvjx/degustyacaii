...
export default function SyncIndicator(){
 ...
 return <div className="fixed left-1/2 top-3 z-[100] -translate-x-1/2 rounded-full bg-black px-3 py-1.5 text-[11px] font-semibold text-white shadow-lg dark:bg-white dark:text-black"><span className="mr-1 inline-block animate-pulse">•</span>Sincronizando...</div>;
}
