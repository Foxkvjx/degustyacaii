  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-24 sm:pb-0">
      <div className="mx-auto max-w-5xl px-5 py-8 sm:px-8 sm:py-12">
        <header className="mb-10 sm:mb-14"><p className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-500">Degusty Açaí</p><h1 className="mt-3 text-3xl font-semibold tracking-[-0.04em] text-slate-900 sm:text-5xl">Controle da operação</h1><p className="mt-3 max-w-xl text-sm leading-6 text-slate-500 sm:text-base">Estoque, vendas, gastos, clima e calendário em um único painel.</p></header>
